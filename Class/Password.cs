...
namespace Pressure_Sensor_EOL
{
    ...
    {
        public IniFiles ini;
        public const string FUNCTION_MODEL_PATH = @"C:\Users\abc\Data\FINAL_Model.ini";
    ...
    class Password
    {
        ...
        public const string PASSWD_PATH = @"C:\Users\abc\Data\Passwd.ps";
        ...
        public void Save(string password)
        {
            ...
            sd.Serialize(PASSWD_PATH, password);
        }
        public string Load()
        {
